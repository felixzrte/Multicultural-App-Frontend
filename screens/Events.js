      ...
      <Animated.View style={{opacity, transform: [{scale}]}}>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            />
            <View style={styles.headerContainer}><McText body1  numberOfLines={1}>{item.eventsItemName}</McText></View>
            <View style={styles.headerContainer}><McText body2 numberOfLines={1}>Gala{item.eventsItemPrice}</McText></View>
          </TouchableOpacity>
        </View>
      </Animated.View>
      </View>
